    ...
    >
      <div className="container px-6 mx-auto max-w-5xl h-full flex items-end">
        <div className="hero-description mb-40">
          <h2 className="text-primary-text font-bold text-2xl md:text-5xl text-center md:text-left">
            Beyond Expectation
          </h2>
          <p className="text-primary-text text-base md:text-xl text-center md:text-left max-w-max md:max-w-[35rem] mt-2 font-albertSans">
